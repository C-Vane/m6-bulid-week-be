...
var renderedTemplate = createTemplate("C:/Users/tyan/Documents/GitHub/m6-bulid-week-be/src/services/Profiles/PDF/views/cv.twig", cvData);
...
function getRoot() {
  ...
  if (devMode) {
    ...
    return root + "src/services/Profiles/PDF/views/" + template;
  }
}
